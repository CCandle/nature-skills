...
- Polish language, not evidence. Do not make claims stronger.
- Do not remove limitation statements.
- Preserve engineering terms, variable names, units, and calibration
  expressions.
- If a phrasing change would alter technical meaning, reject the
  change and explain why.
- Use nature-polishing's phrase patterns as suggestions, not mandates.
